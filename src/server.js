...
app.get("/api/health", (_req, res) => {
  ...
  res.json({
    ...
    geo: "ESRI corridor layer + routing preview + road network avoidance + flood/wind/combined hazard fusion — GET /api/geo/routing/network",
...
app.get("/api/status", (_req, res) => {
  res.json({
    ...
    modules: {
      ...
      geo: "esri_corridor_layer + routing_preview + road_network_avoidance + flood_hazard_overlay + wind_hazard_overlay + multi_hazard_fusion",
